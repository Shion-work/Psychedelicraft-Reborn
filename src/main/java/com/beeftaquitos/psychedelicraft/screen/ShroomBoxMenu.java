...
public class ShroomBoxMenu extends AbstractContainerMenu {
    private final ShroomBoxBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ShroomBoxMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData((2)));
    }

    public ShroomBoxMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.SHROOM_BOX_MENU.get(), pContainerId);
        checkContainerSize(inv, 4);
        blockEntity = ((ShroomBoxBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.SHROOM_BOX.get());
    }
