...
public class ShroomBoxScreen extends AbstractContainerScreen<ShroomBoxMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Psychedelicraft.MOD_ID, "textures/gui/shroom_box_gui.png");

    public ShroomBoxScreen(ShroomBoxMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
