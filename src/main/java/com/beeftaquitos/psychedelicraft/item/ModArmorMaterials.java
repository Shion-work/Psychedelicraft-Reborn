...
public enum ModArmorMaterials implements ArmorMaterial {
    ASBESTOS("asbestos", 15, new int[]{1, 3, 5, 2}, 25, SoundEvents.ARMOR_EQUIP_GOLD, 0.5F, 0.0F, () -> {
        return Ingredient.of(ModItems.ASBESTOS_INGOT.get());
    }),
    MOGUS("mogus", 50, new int[]{3, 6, 8, 3}, 40, SoundEvents.ARMOR_EQUIP_NETHERITE, 4.0F, 0.5F, () -> {
        return Ingredient.of(ModItems.GOLD_PLATED_MOGUS.get());
    });
    ...
    public String getName() {
        return Psychedelicraft.MOD_ID + ":" + this.name;
    }
