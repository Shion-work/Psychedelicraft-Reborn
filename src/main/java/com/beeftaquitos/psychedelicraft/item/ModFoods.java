...
public class ModFoods {
    ...
    public static final FoodProperties LUSCIOUS_SHROOM = (new FoodProperties.Builder()).nutrition(2).saturationMod(.02f)
            .effect(new MobEffectInstance(MobEffects.HUNGER, 1200, 0), 1).alwaysEat().build();
    public static final FoodProperties ECSTASY = (new FoodProperties.Builder()).nutrition(2).saturationMod(.02f)
            .effect(new MobEffectInstance(MobEffects.HUNGER, 1200, 0), 1).alwaysEat().build();
    public static final FoodProperties WARIO_ECSTASY = (new FoodProperties.Builder()).nutrition(2).saturationMod(.02f)
            .effect(new MobEffectInstance(MobEffects.HUNGER, 1200, 0), 1).alwaysEat().build();
